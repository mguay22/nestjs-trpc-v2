...
<Callout type="warn">
  If you don't have a NestJS project setup yet, please visit our <Link href="/docs/nestjs" className="underline">NestJS Quickstart Guide</Link> or check out the official <Link href="https://docs.nestjs.com" target={'_blank'} rel={'nofollow'} className="underline">NestJS documentation</Link>
</Callout>
